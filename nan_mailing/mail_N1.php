...
$db = Database::connect();
$items = $db->query("SELECT * FROM etudiant_1_18");
?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header col-md-10" >
                                <strong class="card-title">MAIL N1.18</strong>
                                <?php
                                 $db = Database::connect();

                               $statMail = $db->prepare("SELECT email FROM etudiant_1_18");
                       ...
                       while ($itemMail = $statMail->fetch()) 
                       {
                        ...
                        Database::disconnect();
                      ?>
                               <a href="mailto:<?php echo $email ?>"style="background-image: linear-gradient(to bottom, #9d1f8d, #811581);" class="btn btn-success btn-md"><span class="fa fa-envelope"></span> E-MAIL A TOUS LES ETUDIANTS N1.18</a>
                <canvas id="" width="100%" height="10"></canvas>
                    ...
                    while($newletter = $items -> fetch()){ ?>
                                  <tr>
                                      ...
                                      <td><?php echo $newletter['nom_etud']; ?></td>
