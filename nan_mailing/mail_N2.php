...
$db = Database::connect();
$items = $db->query("SELECT * FROM etudiant_2_19");
?>
            ...
            <div class="animated fadeIn">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header col-md-10" >
                                <strong class="card-title">NAN 2.19</strong>
                                <?php
                                 $db = Database::connect();

                               $statMail = $db->prepare("SELECT email FROM etudiant_2_19");
                       ...
                       while ($itemMail = $statMail->fetch()) 
                       {
                        ...
                        Database::disconnect();
                      ?>
                               <a href="mailto:<?php echo $email ?>"style="background-image: linear-gradient(to bottom, #9d1f8d, #811581);" class="btn btn-success btn-md"><span class="fa fa-envelope"></span> E-MAIL A TOUS LES ETUDIANTS N2.19</a>
                <canvas id="" width="100%" height="10"></canvas>
                    ...
                    while($newletter = $items -> fetch()){ ?>
                                  <tr>
                                      <td><?php echo $newletter['id_etudiant']; ?></td>
                                      <td><?php echo $newletter['nom_etudiant']; ?></td>
                                      <td><?php echo $newletter['prenom_etudiant']; ?></td>
                                      <td><?php echo $newletter['numero']; ?></td>
                                      <td><?php echo $newletter['mail_etudiant']; ?></td>
                                      <td width=100>
